  ...
  describe('Album Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call User query and add missing value', () => {
        ...
        const user: IUser = { id: '5279b2a3-ac5c-49dc-8b65-eef3d5f556d5' };
        album.user = user;

        const userCollection: IUser[] = [{ id: '8db45d2c-ec2f-4d0b-af6b-c90b01dd5d1d' }];
      ...
      it('Should update editForm', () => {
        const album: IAlbum = { id: 456 };
        const user: IUser = { id: '9de88cdc-5be9-4a78-877c-e82f6a14550b' };
        album.user = user;
